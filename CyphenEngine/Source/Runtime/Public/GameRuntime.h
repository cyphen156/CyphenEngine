...
//   - 전달받은 GameObject 본인의 GlobalUpdate / GlobalFinalUpdate 참여를
//     Runtime-global Function Group에 직접 등록합니다.
//   - 자식 GameObject와 Component의 실행 참여는 처리하지 않습니다.
//
// Destroy:
//   - GameObject의 다형적 Destroy 경로를 통해서만 호출합니다.
//   - GameObject 본인의 Runtime-global Function Group 등록을 제거합니다.
...
//   - Runtime-global Function Group 등록과 실행
...
private:
	...
	std::vector<UpdateFunction> globalUpdateFunctions;
	std::vector<UpdateFunction> globalFinalUpdateFunctions;
};
